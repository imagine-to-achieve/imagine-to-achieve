...
class MultiChannelProcessGroup:
    ...
    def init(
        ...
        Args:
            ...
            store (Optional[dist.Store]): An already-bound rendezvous store.
        ...
        if store is not None:
            ...
            # Match torch rendezvous semantics while keeping each collective's
            # keys isolated inside the explicitly supplied TCPStore.
