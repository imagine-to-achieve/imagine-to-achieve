...
def get_model(cfg: DictConfig):
    ...
    elif model_type == SupportedModel.COSMOS:
        from rlinf.models.embodiment.cosmos import get_model
    ...
    worker = _get_worker_if_available()
    torch_platform = getattr(worker, "torch_platform", None)
