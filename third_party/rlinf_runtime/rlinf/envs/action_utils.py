...
def prepare_actions(
    ...
    if env_type == SupportedEnvType.LIBERO:
        ...
        # A and B share the exact Cosmos action contract; no simulator adapter
        # or LIBERO action transformation belongs between them.
        chunk_actions = raw_chunk_actions
    elif env_type in [
        SupportedEnvType.OPENSORAWM,
        SupportedEnvType.WANWM,
        SupportedEnvType.CTRLWORLDWM,
        SupportedEnvType.COSMOSSELFCTRLWORLD,
    ]:
